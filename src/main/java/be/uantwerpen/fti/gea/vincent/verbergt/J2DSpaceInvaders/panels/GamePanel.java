...
public class GamePanel extends JPanel {
    ...
    /**
     * The panel where we should draw on.
     */
    public final JPanel drawingPanel = new JPanel(null, true) {
        /**
         * Paints each of the entities in this container.
